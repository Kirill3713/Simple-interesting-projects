...
def play_game() -> None:
    ...
    words = ['задача', 'высокопревосходительство', 'виселица', 'амарант', 'факториал', 'калькулятор', 'облако', 'астрономия', 'дезоксирибонуклеиновая кислота', 'время', 'буква', 'карта', 'ананас', 'метилпропенилендигидроксициннаменилакрилическая кислота', "болото", "долото"]
